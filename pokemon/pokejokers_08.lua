...
return {name = "Pokemon Jokers 211-240", 
        list = {qwilfish, scizor, heracross, teddiursa, ursaring, corsola, remoraid, octillery, delibird, mantine, skarmory, kingdra, phanpy, donphan, porygon2, stantler, smeargle, tyrogue, hitmontop, smoochum, elekid, magby},
}
